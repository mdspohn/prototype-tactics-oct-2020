class CombatController {
    ...
    async _initialize(scene) {
        ...
        this.entities[0].moveTo(this.layout.getLocation(5,5));
        this.entities[0].moveTo(this.layout.getLocation(5,6));
        this.entities[0].moveTo(this.layout.getLocation(5,7));
        this.entities[0].moveTo(this.layout.getLocation(5,8));
        this.entities[0].moveTo(this.layout.getLocation(4,8));
        this.entities[0].moveTo(this.layout.getLocation(4,7));
        this.entities[0].moveTo(this.layout.getLocation(5,7));
        this.entities[0].moveTo(this.layout.getLocation(6,7));
